...
def run_trnascan(
    ...
    num_threads: int = 1,
    bedtools_path: str = "/hps/software/users/ensembl/ensw/C8-MAR21-sandybridge/linuxbrew/bin/bedtools",
) -> None:
    """
    Executes tRNAscan-SE on genomic slices
        ...
        :type bedtools_path: str, default "/hps/software/users/ensembl/ensw/C8-MAR21-sandybridge/linuxbrew/bin/bedtools"
...
def _multiprocess_trnascan(  # pylint: disable=too-many-locals
    ...
    seq = get_sequence(region_name, int(start), int(end), 1, genome_file, trnascan_dir, bedtools_path)
