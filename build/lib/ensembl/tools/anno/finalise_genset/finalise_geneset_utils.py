...
"""Finalise the gene set by selecting the best transcripts from the different 
sources and merging them into a final GTF file.
Use the validation tools RNAsamba, CPC2 and Diamond to validate the coding transcripts
and remove any that are not supported by the evidence. Clean the UTRs and lncRNAs 
and dump the final transcript and translation sequences.
