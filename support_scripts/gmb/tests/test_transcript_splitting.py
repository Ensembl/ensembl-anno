        ...
        df = _make_tx_df(
            [
                (
                    ...
                    "1",
                    "+",
                    [(100, 200), (250, 350), (5000, 5100), (5200, 5300)],  # cluster 1
                ),  # cluster 2, gap = 5000-350-1 = 4649
            ]
        )
        stats = {}
...
class TestMaxSegmentsDrops:
    def test_exceeds_max_segments_is_dropped(self):
        ...
        df = _make_tx_df(
            [
                ("tx1", "gene1", "1", "+", [(100, 200), (1000, 1100), (2000, 2100), (3000, 3100)]),
            ]
        )
        stats = {}
        result = split_mega_transcripts(df, cfg, stats)
