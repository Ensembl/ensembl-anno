...
class TestIntegration:
    ...
    def test_pipeline_runs(self, tmp_path):
        ...
        cmd = [
            ...
            '--scallop', files['scallop'],
            '--stringtie', files['stringtie'],
            '--helixer', files['helixer'],
            '--orthodb', files['orthodb'],
            '--uniprot', files['uniprot'],
            '--genome', files['genome'],
