...
class TestFilterHelixerModels:
    def test_short_cds_removed(self, config):
        ...
        exons = pd.DataFrame({
            ...
            'Strand': ['+'], 'transcript_id': ['hx1'], 'Source': ['Helixer'],
        })
        cds = pd.DataFrame({
            'Chromosome': ['1'], 'Start': [100], 'End': [150],  # 50bp < 90bp
            'Strand': ['+'], 'transcript_id': ['hx1'], 'Source': ['Helixer'],
        })
        stats = {}
    ...
    def test_adequate_cds_kept(self, config):
        ...
        exons = pd.DataFrame({
            'Chromosome': ['1'], 'Start': [100], 'End': [400],
            'Strand': ['+'], 'transcript_id': ['hx2'], 'Source': ['Helixer'],
        })
        cds = pd.DataFrame({
            'Chromosome': ['1'], 'Start': [100], 'End': [400],  # 300bp
            'Strand': ['+'], 'transcript_id': ['hx2'], 'Source': ['Helixer'],
        })
