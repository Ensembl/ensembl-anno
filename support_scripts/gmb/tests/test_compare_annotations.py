...
def test_synthetic_classification_with_remapping():
    ...
    ref_res, cons_res = classify_locus_pairs(
        mapped_ref_genes, mapped_ref_exons, ref_cds,
        cons_genes, cons_exons, cons_cds, cons_mrna
    )
...
def test_isoform_aware_and_cds_classification():
    ...
    ref_genes = pd.DataFrame([{'Chromosome': '1', 'Start': 1000, 'End': 2000, 'Strand': '+', 'ID': 'gene1'}])
    ref_exons = pd.DataFrame([
        {'Chromosome': '1', 'Start': 1000, 'End': 2000, 'Strand': '+', 'transcript_id': 'tx1', 'Parent': 'gene1'},
        {'Chromosome': '1', 'Start': 1000, 'End': 1500, 'Strand': '+', 'transcript_id': 'tx2', 'Parent': 'gene1'},
        {'Chromosome': '1', 'Start': 1800, 'End': 2000, 'Strand': '+', 'transcript_id': 'tx2', 'Parent': 'gene1'}
    ])
    # Ref CDS: tx1 1100-1900, tx2 1100-1500 and 1800-1900
    ref_cds = pd.DataFrame([
        {'Chromosome': '1', 'Start': 1100, 'End': 1900, 'Strand': '+', 'transcript_id': 'tx1', 'Parent': 'tx1'},
        {'Chromosome': '1', 'Start': 1100, 'End': 1500, 'Strand': '+', 'transcript_id': 'tx2', 'Parent': 'tx2'},
        {'Chromosome': '1', 'Start': 1800, 'End': 1900, 'Strand': '+', 'transcript_id': 'tx2', 'Parent': 'tx2'}
    ])
    ...
    cons_genes = pd.DataFrame([{'Chromosome': '1', 'Start': 900, 'End': 2050, 'Strand': '+', 'ID': 'cons_gene1'}])
    cons_exons = pd.DataFrame([
        {'Chromosome': '1', 'Start': 900, 'End': 920, 'Strand': '+', 'transcript_id': 'cons_tx1', 'Parent': 'cons_gene1'},
        {'Chromosome': '1', 'Start': 950, 'End': 1500, 'Strand': '+', 'transcript_id': 'cons_tx1', 'Parent': 'cons_gene1'},
        {'Chromosome': '1', 'Start': 1800, 'End': 2050, 'Strand': '+', 'transcript_id': 'cons_tx1', 'Parent': 'cons_gene1'}
    ])
    cons_cds = pd.DataFrame([
        {'Chromosome': '1', 'Start': 1100, 'End': 1500, 'Strand': '+', 'transcript_id': 'cons_tx1', 'Parent': 'cons_tx1'},
        {'Chromosome': '1', 'Start': 1800, 'End': 1900, 'Strand': '+', 'transcript_id': 'cons_tx1', 'Parent': 'cons_tx1'}
    ])
    cons_mrna = pd.DataFrame([
        {'Chromosome': '1', 'Start': 900, 'End': 2050, 'Strand': '+', 'transcript_id': 'cons_tx1', 'Parent': 'cons_gene1', 'Evidence': 'Helixer'}
    ])

    ref_res, cons_res = classify_locus_pairs(ref_genes, ref_exons, ref_cds, cons_genes, cons_exons, cons_cds, cons_mrna)
