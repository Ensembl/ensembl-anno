import pytest
from gff3_validate import validate_transcript, trim_utrs
from config import ValidationConfig, UtrConfig
...
def test_drift_prevention():
    ...
    violations, max_drift, span = validate_transcript(mrna_row, exon_rows, cds_rows, utr_rows, config=ValidationConfig(max_feature_drift_bp=1500))
...
def test_strict_utr_trimming():
    ...
    trimmed_5p, trimmed_3p, was_trimmed = trim_utrs(utr_5p_rows, utr_3p_rows, cds_rows, exon_rows, cfg)
...
def test_compute_percentile_guardrails():
    ...
    from gene_model_builder import compute_percentile_guardrails
    ...
    data = [
        {'transcript_id': 'hc1', 'Feature': 'exon', 'Start': 1000, 'End': 3000, 'Source': 'StringTie'},
        {'transcript_id': 'hc2', 'Feature': 'exon', 'Start': 1000, 'End': 2500, 'Source': 'StringTie'},
        {'transcript_id': 'hc2', 'Feature': 'exon', 'Start': 4500, 'End': 5000, 'Source': 'StringTie'},
        {'transcript_id': 'lc1', 'Feature': 'exon', 'Start': 1000, 'End': 11000, 'Source': 'Scallop'},
    ]
